...
export class ActorsController {
  ...
  @Patch(":id")
  async update(@Param("id") id: number, @Body() updateActorDto: UpdateActorDto ) {
    try {
      ...
      const res = await this.updateActorUseCase.execute(actor, updateActorDto.firstName, updateActorDto.lastName);
      return {
